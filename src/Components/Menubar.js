...
const Menubar = ({hidemenu}) => {
  return (
    <>
            ...
            <div className='menustyle' style={{display: 'flex',flexDirection:'column', alignItems:'center',backgroundColor: 'white',fontFamily: 'Lato'
            }}>
           
          <p style={{paddingTop:'20px'}}><Link activeClass="active" to="home" spy={true} smooth={true} onClick={hidemenu}>Home</Link></p>
          <hr style={{width:'100px',height:'2px',backgroundColor:'silver'}}/>
